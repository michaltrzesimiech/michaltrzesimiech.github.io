---
layout: post
title:  "Exploring ways to make technology work for democracy in Europe"
author: Michal Trzesimiech
published: true
date:   2019-12-18 09:14:39 +0100
categories: 
---

The future of Europe is written across its fragmented datasets. Eighty-nine percent of European households use and produce data while on the Internet[^1], most on a daily basis[^2]. Putting that to good use is among the most ambitious challenges of our age. Coming to agree on what’s “good” is the role of a technology that’s long under construction—democracy itself.

## The disconnected Europe

“Like electricity in the past, artificial intelligence (AI) is transforming our world.” declares the opening sentence of the EU’s “Coordinated Plan on Artificial Intelligence”[^3]. “The Commission [...] encourages the use of this powerful technology to help solve the world’s biggest challenges: from curing diseases to fighting climate change and anticipating natural disasters, to making transport safer and fighting crime and improving cybersecurity.”[^4]



There are applications of AI in development for each of those challenges and more, all over the world, and Europe is not leading the way. In fact, it’s mostly falling behind the US and China, missing out on “a significant source of potential new economic dynamism”[^5] and adding to it’s already existing digital gap. It’s captured digital potential[^6] is estimated at 12%[^7] —two-thirds of the potential captured by the United States[^8].



And yet, “if Europe develops and diffuses AI according to its current assets and digital position relative to the world it could add some €2.7 trillion, or 20 percent, to its combined economy output [...] through 2030”, we read in a McKinsey report. “Such an impact would be roughly double that of other general-purpose technologies adopted by developed countries in the past.”[^9]



Among European countries, the first to clarify their goal of becoming Europe’s prime location for AI research was Finland (in partnership with bordering Estonia and Sweden)[^10] in 2017. Soon, it was followed by Denmark[^11], Italy[^12], France[^13], the UK[^14], Sweden[^15], and Germany[^16]. In fall 2018, the previously quoted plan was announced by the European Commission, following Communication on Artificial Intelligence for Europe[^17] in April that same year.



One of the many needs of this emerging ecosystem is that of cooperation on the international level. But that is yet to take shape, judged, at least, by how the plan to build a joint AI research centre has failed[^18], not even a year since the Commission’s plan was published.
...
There’s no shortage of challenges on the intersection of technology and the public sphere. Take the Russian interference in the 2016 US presidential elections, when 115 pro-Trump fake stories were shared on Facebook a total of 30 million times. The result for the 41 pro-Clinton fake stories was: 7.6 million “shares"[^19]. It’s debated whether this could have had a pivotal role in the election of President Trump. That’s but a single thread in the continuous campaign of online influence and social manipulation[^20], affecting more than elections only[^21].



Our susceptibility to fake news is rooted deeper in human bias[^22] [^23] than in computer software. It’s amplified by technology, though, and so a part of its domain.
It works as a reward to have our prior beliefs confirmed. Our brains crave the reward, not the uneasy truth. There’s a demand for that, and so there are those who cash in on it, selling us half-truths or straight lies. And we have no easy ways to filter lies out on the scale of the whole Internet (there’s too much of linguistic nuisance to write a rule for it). Someone has to play the role of the arbiter of truth.



Mark Zuckerberg, during the much talked about congressional hearings in 2018 referred to AI more than thirty times in ten hours, saying that it will “one day be smart, sophisticated and eagle-eyed enough to fight against a vast variety of platform-spoiling misbehavior, including fake news, hate speech, discriminatory ads and terrorist propaganda”[^24].



It likely won’t happen soon[^25] [^26], but if it could—would we understand the solution enough to outsource our judgement to it in a hurry (would the source of it even be open to us)? Should we let Facebook alone decide if the solution is good enough? Who should ensure the safety of it in our hyperconnected world?



Three years after the feral 2016, it’s ever harder to find truth in an increasingly polarized and hyperpartisan infosphere[^27] [^28], yet the legal and technological solutions are still to be found. And since attempts at exploiting our flaws for political and financial benefits are unlikely to stop tomorrow[^29], these problems already follow us into the new decade.
